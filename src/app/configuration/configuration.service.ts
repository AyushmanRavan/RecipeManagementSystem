...
export class ConfigurationService {
  ...
  downloadEnable = () => this.rest.get('downloadEnable');
  getAllRecipe = () => this.rest.get('getAllRecipe');
  getRecipeById = (id) => this.rest.get(`getRecipe/${id}`);

  createRecipe = (payload) => this.rest.post('createRecipe', payload);
  updateRecipe = (payload) => this.rest.post('updateRecipe', payload);
  deleteRecipe = (id, user_name) => this.rest.delete('deleteRecipe', id, user_name);//deleteRecipe/2/user_name
